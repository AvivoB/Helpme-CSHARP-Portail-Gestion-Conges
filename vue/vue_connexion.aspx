            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Help'Me</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" method="POST">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" type="submit" name="connecter">Connexion</button>
                </div>
              </form>
